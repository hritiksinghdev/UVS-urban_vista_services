...
export function AuthPanel({ mode, onToggle }: AuthPanelProps) {
    ...
    return (
        <motion.div
            ...
            className="w-full max-w-[420px] p-7 md:p-10 rounded-[24px] bg-[rgba(15,23,42,0.65)] backdrop-blur-xl border border-[rgba(96,165,250,0.25)] shadow-[0_20px_50px_rgba(59,130,246,0.15)] relative overflow-hidden group z-10"
        >
